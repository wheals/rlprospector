...
'        next
   ...
   '        
            ...
            if player.hull>0 then 'playermovement
                ...
                if key=key_dr then
                    com_dropmine(player,mines_p(),mines_v(),mines_last)
                    player.energy+=1
                endif
        ...
        if localturn mod 5=0 then
            for e=1 to e_last
                if e_track_v(e)>0 then
                    ...
                    e_map(e_track_p(e).x,e_track_p(e).y)=0
                endif
            next
        endif
            ...
            if rnd_range(1,6)+rnd_range(1,6)+gunner>=w.heat/25  then
                ...
                if roll>11 then
                    ...
                    if w.ammomax=0 then
                        ...
                        target=com_hit(target,w,0,range)
                        c=7
                    endif
